...
function LoginForm() {
  ...
  return (
    <form
      onSubmit={submit}
      className="w-full max-w-sm space-y-4 rounded-2xl border border-slate-200 bg-white p-6"
    >
      ...
      <input
        ...
        className="w-full rounded-lg bg-white border border-slate-200 px-3 py-2 outline-none focus:border-indigo-500"
